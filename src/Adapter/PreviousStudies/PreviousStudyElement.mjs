...
export class PreviousStudyElement extends HTMLElement {
     ...
     */
    static new(css_api, label_service, localization_api, previous_studies, remove_previous_study_function, values = null) {
        return new this(
            css_api,
            label_service,
            localization_api,
     ...
     * @private
     */
    constructor(css_api, label_service, localization_api, previous_studies, remove_previous_study_function, values) {
        super();
...
export const PREVIOUS_STUDY_ELEMENT_TAG_NAME = `${ELEMENT_TAG_NAME_PREFIX}previous-study`;
