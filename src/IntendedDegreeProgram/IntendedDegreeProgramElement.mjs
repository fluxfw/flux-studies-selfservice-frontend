...
export class IntendedDegreeProgramElement extends HTMLElement {
     ...
     */
    static new(flux_css_api, flux_localization_api, label_service, intended_degree_program, chosen_intended_degree_program_function, back_function = null) {
        return new this(
            flux_css_api,
            flux_localization_api,
            label_service,
     ...
     * @private
     */
    constructor(flux_css_api, flux_localization_api, label_service, intended_degree_program, chosen_intended_degree_program_function, back_function) {
        super();
